...
```shell
python -m pip install --require-virtualenv --no-cache-dir 'hana-ml==2.21.24090900' ipywidgets 'jinja2>=3.0.0' pydotplus graphviz 'shapely>=1.7.1' 'matplotlib==3.8.*' plotly
```
